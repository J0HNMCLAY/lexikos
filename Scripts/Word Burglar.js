...
//-URL---------------------------------------------------
const dictionaryURL = 'https://www.merriam-webster.com/browse/dictionary/';
class URL_LETTER {
    constructor () {
        this.Letter = 'a';
        this.Number = 0;
...
function Get_Words () {
    return new Promise((resolve, reject) => 
    {
        ...
        //-Setup URL Extra
        URL_suffix.Update(); $log(`URL suffix::${URL_suffix.Get()}`);
        let url = dictionaryURL + URL_suffix.Get();
